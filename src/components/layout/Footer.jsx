  ...
  return (
    <footer className="bg-[#080808] border-t border-[#B8860B]/20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-14 md:py-16">
        ...
        {/* Social Section */}
        <div className="mt-12 pt-8 border-t border-[#B8860B]/15">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <h4 className="text-white font-bold text-[13px] mb-1">Connect With Kay Amazing Grace Global</h4>
              <p className="text-white/30 text-[11px] max-w-sm">
                Follow us for new bale arrivals, wholesale updates, and latest thrift collections.
              </p>
            </div>
            <div className="flex items-center gap-3">
              {[
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label={label}
                  className="w-9 h-9 flex items-center justify-center border border-white/10 text-white/40 hover:text-[#B8860B] hover:border-[#B8860B]/40 transition-all duration-200"
                >
        ...
        {/* Bottom */}
        <div className="mt-6 pt-6 border-t border-white/6 flex flex-col md:flex-row items-center justify-between gap-3">
